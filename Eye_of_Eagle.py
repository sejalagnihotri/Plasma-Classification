...
DIR="C:/Users/Pararth Dave/Desktop/DAIICT/sem2/Numerical Method/Project/NM_PRUJECT_WITH_MS"
...
if feature_name=="Surface Touch Detection":
    ...
    for i in all_files:
        ...
        image_holder.image(img,width=400)
...
# In[32]:
    ...
    for i in all_files:
        ...
        if max(norm_row)>100 or max(norm_col)>100:
            ...
            text_holder4.markdown("<h3 style='text-align: left; color: maroon;'>Plasma's Area: "+str(area)+"</h3>",unsafe_allow_html=True)
        else:
            text_holder.markdown("<h3 style='text-align: left; color: red;'>Plasma is not touching the surface!</h3>",unsafe_allow_html=True)
        time.sleep(0.6)
        text_holder.text("")
